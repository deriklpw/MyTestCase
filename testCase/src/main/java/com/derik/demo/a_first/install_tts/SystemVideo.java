package com.derik.demo.a_first.install_tts;
...
public class SystemVideo extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layout.addView(btn1, new ViewGroup.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT));
        layout.addView(btn2, new ViewGroup.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT));
        layout.addView(btn3, new ViewGroup.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT));
        layout.addView(btn4, new ViewGroup.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT));
            ...
            public void onInit(int i) {
                if (i == TextToSpeech.SUCCESS) {
                    ...
                    if (result != TextToSpeech.LANG_AVAILABLE && result != TextToSpeech.LANG_COUNTRY_AVAILABLE) {
                        Toast.makeText(SystemVideo.this, "No support", Toast.LENGTH_LONG).show();
                    }
                }
            }
        });
        ...
        btn2.setText("AutoInstall");
        btn3.setText("TTS");
        btn4.setText("UnInstall");
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                it.setDataAndType(Uri.parse("/sdcard/" + (str.equals("") || str == null ? "v2.mp4" : str)), "video/mp4");
                startActivity(it);
            }
        });
    ...
    public void downAndInstall() {
        ...
        autoInstall.install(SystemVideo.this);
    }
    ...
    protected File downLoadFile(String httpUrl) {
        ...
        try {
            ...
            if (conn.getResponseCode() >= 400) {
                Toast.makeText(SystemVideo.this, "连接超时",
