...
import com.derik.demo.net.url.util.DownUtil;
...
public class HttpURLTestActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        urlEdit.setHint(urlDefault);
        targetPathEdit = (EditText) findViewById(R.id.target);
        targetPathEdit.setHint(pathDefault);
