 ...
 */
public class DesktopTestActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        click.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Parcelable icon = Intent.ShortcutIconResource.fromContext(DesktopTestActivity.this, R.drawable.ic_launcher);

                // 这里只能启动Launcher的Activity
                Intent myIntent = new Intent(DesktopTestActivity.this, MainActivity.class);

                intent.putExtra(Intent.EXTRA_SHORTCUT_NAME, "Liping");
                intent.putExtra(Intent.EXTRA_SHORTCUT_ICON_RESOURCE, icon);
                intent.putExtra(Intent.EXTRA_SHORTCUT_INTENT, myIntent);
                sendBroadcast(intent);
                Log.i("DesktopTestActivity", "clicked");
            }
        });
